...
\author{Dakshith~Rajkumar,~\textit{Independent Researcher}
\thanks{D. Rajkumar is an Independent Researcher. E-mail: daks2edu@gmail.com. ORCID: 0009-0006-2907-8815.}}

\markboth{Preprint, 2026}{Rajkumar: Vel-v5.5}
...
by a local steering law computed from that shared map. Vel-v4.3 introduced
...
The author acknowledges Gnaneswar Kumar Pullaganti and Dakshith Karthikeyan
for their contributions during the early science fair phase of the Vel
project. Their involvement was limited to that initial stage; they had no
role in the development of Vel-v5.5 or any part of this work. The author
used Claude (Anthropic) for simulation code implementation assistance,
LaTeX formatting, and prose editing; all research concepts, experimental
design, and scientific conclusions are the original work of the author.
...
is an independent researcher specializing in decentralized swarm
intelligence and autonomous robotic navigation. His work focuses on the
Vel protocol series, specifically Map-Aware Gradient Repulsion (MAGR) and
spatio-temporal efficiency in multi-agent systems.
