/*
  ============================================================
  Vel-v6.0 — ESP32 Brain Firmware (MAGR condition, dual-board)
  ============================================================
  ...
  the Arduino R3 over a one-way serial wire. The Arduino runs
  Arduino_Motor_Executor_v2.ino and drives the TB6612FNG shield
  using the verified LAFVIN V2.2 pin map (see that file).
  ...
  Serial link to the Arduino -- ONE-WAY, no resistors needed:
      ...
      (ESP32 RX / GPIO16 is left unconnected -- the Arduino
      never talks back in this design)
      Also connect ESP32 GND <-> Arduino GND (shared ground rail
      on the breadboard) or the link won't read correctly.
  ============================================================
*/
...
#define ROBOT_ID 1
#define GRID_SIZE 16
#define REPULSION_GAIN 1.5f
#define MOMENTUM_MU 0.99f
